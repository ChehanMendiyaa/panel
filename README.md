...
```
bash <(curl -Ls https://raw.githubusercontent.com/ChehanMendiyaa/panel/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/ChehanMendiyaa/panel/master/install.sh) v1.7.9
```
